...
var (
	...
	colorJsonFormatter *colorjson.Formatter = colorjson.NewFormatter()
)
...
func (w ConsoleWriter) writeFields(evt map[string]interface{}, buf *bytes.Buffer) {
	...
	for i, field := range fields {
		...
		case json.Number:
			buf.WriteString(fv(fValue))
		default:
			b, err := colorJsonFormatter.Marshal(fValue) //zerolog.InterfaceMarshalFunc(fValue)
			if err != nil {
