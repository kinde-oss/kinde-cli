...
Management API scopes need to be granted to the application you are using to run this command.`,
	...
	ops := map[string][]commandOperationPair[string, management_api.OperationName]{
		...
		"api_keys": {
			...
			{"delete", management_api.DeleteApiKeyOperation},
			{"get", management_api.GetApiKeyOperation},
			{"get_all", management_api.GetApiKeysOperation},
			{"rotate", management_api.RotateApiKeyOperation},
			{"verify", management_api.VerifyApiKeyOperation},
		},
		"applications": {
